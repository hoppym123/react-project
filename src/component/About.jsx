        ...
        <div className="grid gap-12 lg:grid-cols-[0.95fr_0.85fr] lg:items-center">
          <div data-aos="fade-right">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              <div className="rounded-3xl bg-slate-900/80 p-6 ring-1 ring-white/10" data-aos="zoom-in" data-aos-delay="0">
              ...
              <div className="rounded-3xl bg-slate-900/80 p-6 ring-1 ring-white/10" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-[#541b1b]/10 p-10 shadow-2xl shadow-black/30" data-aos="fade-left">
