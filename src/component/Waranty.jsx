...
const Warranty = () => {
    ...
    return (
        <div>
            ...
            <p>We also provide a 5-year warranty on materials, ensuring that any issues arising from material defects will be addressed promptly.</p>
            ...
            <div className="mt-4">
                <a onClick={() => navigate('/contact')}  className="text-amber-200 hover:text-amber-400 transition-colors font-semibold position center">Contact Us for Warranty Claims</a>
